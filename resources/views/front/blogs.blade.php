                        ...
                        <div class="news-card-one">
                            ...
                            <div class="news-card-info">
                                ...
                                <ul class="news-metainfo list-style">
                                    <li><i class="fi fi-rr-calendar-minus"></i><a href="{{ \App\Models\blog_setting::getSiteUrl() }}/blog/{{ $blogWrite->id }}/{{ \App\Http\Controllers\admin\tool\functionController::seo($blogWrite->name) }}.html">{{ substr($blogWrite->created_at,0,11) }}</a></li>
