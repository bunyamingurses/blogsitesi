...
(function(factory) {
    ...
    (function(H) {
        ...
        seriesType('boxplot', 'column', {
             ...
             * @sample  {highcharts} highcharts/plotoptions/box-plot-styling/
             *          Box plot styling
             * @sample  {highcharts} highcharts/plotoptions/errors-bar-styling/
             *          Error bar styling
             * @since   3.0
             * @product highcharts
             */
            ...
            */
            ...
            drawPoints: function() {
                var series = this,
                    ...
                    right,
                    halfWidth,
                    // errors bar inherits this series type but doesn't do quartiles
    ...
    (function(H) {
         ...
         * used on graphs to indicate the errors, or uncertainty in a reported
         * measurement.
         *
         * @sample       highcharts/demo/errors-bar/
         *               Error bars
        ...
        seriesType('errorbar', 'boxplot', {
            ...
            /**
             * The parent series of the errors bar. The default value links it to
